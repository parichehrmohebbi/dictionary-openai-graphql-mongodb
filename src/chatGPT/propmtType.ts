export enum PromptType {
  ...
  WORD_OBJECT_PROMPT = "I need a json object about {0} including these properties: isRelatedToKnowledge: a boolean showing {0} is related to knowledge or not, definition:a verbose comprehensive  definition of {0}, relatedLinks: maximum 10 related links array including title and url , relatedTopics: top 10 related topics as an string array . do not write any explanations or comment. just return the object in json.",
}
