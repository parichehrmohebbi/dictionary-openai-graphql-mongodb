export enum PromptType {
  ...
  WORD_OBJECT_PROMPT = "I need a json object about {0} including these properties: isRelatedToTechnology: a boolean showing {0} is related to web development or computer science or software technologies or not, definition: an extensive definition of the word, relatedLinks: top 10 related links array including title and url , relatedTopics: top ten related topics as an string array . do not write any explanations or comment. just return the object in json.",
}
