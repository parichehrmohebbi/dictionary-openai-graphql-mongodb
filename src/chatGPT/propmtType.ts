export enum PromptType {
  IS_RELATED_PROMPT = "givee my answer with yes or no. do not write any explanation or comment. Just write yes or no.  is {0} related to web development or computer science or software technologies?",
